...
# Nombre del trabajo
#SBATCH --job-name=Mistral_Perplexity_Comparison
...
#SBATCH --output="/home/est_posgrado_gustavo.angeles/Tercer Semestre/NLP-Vision/Tareas/T2/logs/mistral_perplexity_comparison.log"

# Archivo de error donde se guardarán los errores del trabajo
#SBATCH --error="/home/est_posgrado_gustavo.angeles/Tercer Semestre/NLP-Vision/Tareas/T2/logs/mistral_perplexity_comparison.err"
...
python "$PYTHON_SCRIPT" --compare_base
