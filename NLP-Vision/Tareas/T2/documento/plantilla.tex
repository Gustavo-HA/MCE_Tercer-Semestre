...
El script contiene el conjunto de artistas y el número de canciones a scrapear directamente en el código (En mi caso particular, elegí a \textit{Kendrick Lamar}, \textit{Kanye West} y \textit{Jay-Z}, cada uno con 33 canciones). El comando para ejecutar el script es el siguiente:

\begin{center}
\texttt{python scrape\_songs.py}
\end{center}
